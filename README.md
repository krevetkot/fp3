...
- divided-differences - Строит таблицу разделённых разностей. Возвращает вектор коэффициентов полинома Ньютона: `[a0 a1 a2 ...]`.
...
- process-point - Принимает новую точку входного потока. Обновляет состояние и вычисляет новые выходные значения.
...
5. Вызов `process-point` для каждой новой точки.
